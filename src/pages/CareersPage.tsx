                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs text-neutral-500">{position.posted}</span>
                      </div>
                    </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-neutral-900 mb-2">Application</h3>
              <p className="text-sm text-neutral-600">Submit your application and we'll review it within 48 hours</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold">2</span>
              </div>
              <h3 className="font-semibold text-neutral-900 mb-2">Phone Screen</h3>
              <p className="text-sm text-neutral-600">30-minute call to discuss your background and the role</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold">3</span>
              </div>
              <h3 className="font-semibold text-neutral-900 mb-2">Technical Interview</h3>
              <p className="text-sm text-neutral-600">Role-specific assessment and team interviews</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold">4</span>
              </div>
              <h3 className="font-semibold text-neutral-900 mb-2">Final Interview</h3>
              <p className="text-sm text-neutral-600">Meet with leadership and discuss next steps</p>
            </div>
          </div>
        </div>
      </section>
